...
void vecquant4recons(
  ...
  vecquant4recons_cuda(mat, res, scales, zeros, g_idx);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("vecquant4recons", &vecquant4recons, "Vector 4-bit Quantized Matrix Reconstruction (CUDA) with group-size support");
}
